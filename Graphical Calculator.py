...
btn_enter = tk.Button(root, text = "enter", command=evaluate_calculation, width=5, font=("Arial", 14))
btn_enter.grid(row=6, column = 4)
btn_open = tk.Button(root, text = "(", command=lambda: add_to_calculation("("), width=5, font=("Arial", 14))
btn_open.grid(row=6, column = 1)
btn_close = tk.Button(root, text = ")", command=lambda: add_to_calculation(")"), width=5, font=("Arial", 14))
btn_close.grid(row=6, column = 2)
btn_exponent = tk.Button(root, text = "^", command=lambda: add_to_calculation("**"), width=5, font=("Arial",14))
btn_exponent.grid(row=6, column=3)
root.mainloop()